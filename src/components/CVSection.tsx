...
const CVSection = () => {
  ...
  const desc = content?.cv_description || "Download my professional CV to learn more about my experience, design skills and career journey.";
    ...
    <section className="py-24 px-6">
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto text-center">
        ...
        <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold">
          <a href="/Ratul_Hasan_CV.pdf" download><Download size={18} /> Download CV (PDF)</a>
        </Button>
      </motion.div>
    </section>
  );
