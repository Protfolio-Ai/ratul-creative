...
const categories = ["Design", "Tech", "Video"];
        ...
        {categories.map((cat) => (
          <div key={cat}>
            <motion.h3
              ...
              viewport={{ once: true }}
              className="font-mono-label text-xs tracking-[0.2em] uppercase text-muted-foreground mb-4 border-b border-border/50 pb-2"
            >
              {cat}
            </motion.h3>
              ...
              {skills
                ...
                .map((s, i) => (
                  <motion.div
                    ...
                    className="group p-4 rounded-xl border border-border/50 bg-card/30 backdrop-blur-sm hover:border-primary/30 hover:bg-card/50 hover:shadow-[0_0_20px_-5px_hsl(var(--primary)/0.2)] hover:scale-[1.02] transition-all duration-300"
                  >
                    <div className="flex justify-between mb-2">
                      ...
                      <motion.span
                        ...
                        className="font-mono-label text-sm font-semibold text-primary"
                      >
                        {s.pct}%
                      </motion.span>
                    </div>
                    <div className="h-3 rounded-full bg-secondary/50 backdrop-blur-sm overflow-hidden">
                      <motion.div
                        ...
                        className="h-full rounded-full bg-gradient-to-r from-primary/80 to-primary shadow-[0_0_15px_-3px_hsl(var(--primary)/0.5)]"
                      />
                    </div>
                  </motion.div>
                ))}
